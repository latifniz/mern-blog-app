          ...
          <div className="mb-5 md:mb-0">
            ...
            >
              <div className="w-[150px] md:w-[200px]">
                <img src="/through-my-eyes-logo.jpeg" alt="logo" />
              </div>
            </Link>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:mt-4 sm:grid-cols-3 sm:gap-10">
            ...
            <div>
              ...
              <Footer.LinkGroup col>
                ...
                <Footer.Link
                  href="https://www.linkedin.com/in/abdullatif-nizamani-8537731b6"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Linkdln
        ...
        <div className="w-full sm:flex sm:items-center sm:justify-between sm:px-5">
          ...
          <div className="flex gap-6 mt-4 md:mt-2 md:justify-center">
            <Footer.Icon
              ...
              icon={BsLinkedin}
            />
            <Footer.Icon href="https://github.com/latifniz" icon={BsGithub} />
